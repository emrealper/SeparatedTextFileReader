...
namespace SeparatedTextFileReader.UnitTests.ValidationTest
{
    public class ColumnValidationAndDynamicOrderTests
    {
        ...
        [Theory]
        [InlineData("Project	Description		Category		Savings amount	Currency	")]
        ...
        [Theory]
        [InlineData("Description	Project	Savings amount	Complexity	Responsible	Start date	Currency	Category",
