   ...
   public class DeserializeRowDataTests
    {
        ...
        public void Should_Correctly_Deserialize_Parsed_Row_Data()
        {
            ...
            {
                {0,"2"},{1,"Black and white logo paper"},{3,"2012-06-01 00:00:00.000"},{4,"Office supplies"},{5,"Clark Kent"},
            ...
            Procurement actual = deserializeRowData.Deserialize(properties, values, propertyMapping);
